...
# Ensure script runs from the script's directory so relative paths work
...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd server; npm install --legacy-peer-deps; npm run dev"
