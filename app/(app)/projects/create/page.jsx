  ...
  const renderStep = () => {
    switch (step) {
      case 1:
        return (
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-600">Choose a unique name for your project</p>
          </div>
        );
              ...
              {['GitHub', 'GitLab', 'Bitbucket'].map(prov => (
                ...
                >
                  <CardContent className="pt-6 text-center">
                    ...
                    <Badge className="mt-3">{formData.provider === prov ? 'Selected' : 'Available'}</Badge>
                  </CardContent>
                </Card>
              ))}
            </div>
      ...
      case 6:
        return (
          <div className="space-y-4">
            <label className="block text-sm font-medium mb-2">Deploy Region</label>
                ...
                >
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-gray-600">Latency: {region.latency}</p>
                    </div>
